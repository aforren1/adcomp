...
| dpois(x,lambda=p1,log=TRUE)             | dpois(x,p1,true)         |
| dlnorm(x,meanlog=p1,sdlog=p2,log=FALSE) | dlnorm(x,p1,p2,false)    |
| dlnorm(x,meanlog=p1,sdlog=p2,log=TRUE)  | dlnorm(x,p1,p2,true)     |
